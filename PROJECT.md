...
Baseline 2026/27 chiusa; storico Serie A 2025/26 acquisito; provenienza 112/112 chiusa; controllo di consolidamento creato. Il fronte di classificazione è terminato.

## Prossimo outcome

**Acquisizione quantitativa nativa 2025/26 dei 112 non-matchati.**

Ordine operativo:
1. Serie B 2025/26: presenze, starts/titolarità, minuti, gol, assist, rigori, cartellini e altre metriche disponibili;
2. campionati esteri: stessi campi nella scala nativa e competizione esplicita;
3. Serie C / seconde squadre / youth: dati disponibili + flag di qualità/copertura;
4. multi-stint: una riga per stint prima di qualsiasi aggregazione;
5. QA di copertura;
6. unione con i 384 Serie A per costruire la prima tabella storica 2025/26 dei 496.
